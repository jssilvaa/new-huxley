...
#include "../../../../src/model/ContactListModel.h"
...
template <> constexpr inline auto ContactListModel::qt_create_metaobjectdata<qt_meta_tag_ZN16ContactListModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'setContacts'
        QtMocHelpers::SlotData<void(const QVector<Contact> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void ContactListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setContacts((*reinterpret_cast<std::add_pointer_t<QList<Contact>>>(_a[1]))); break;
        default: ;
        }
    }
}
